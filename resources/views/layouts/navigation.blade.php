...
<div class="h-screen p-3 space-y-2 w-48 text-brand-black">
    <div class="flex justify-center mb-8 items-center">
        ...
        <x-application-logo />
        <span>
            <h1 class="text-base font-semibold text-brand-gray">Orientation.com</h1>
        </span>
    </div>
	<div class="flex flex-col items-center mt-8">
		<img
        id="avatar"
        alt="" class="w-20 h-20 rounded-full bg-gray-500">
		<div >
			<h2 class="text-lg font-semibold text-center">Leroy Jenkins</h2>
