        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <x-nav-link :href="route('logout')"
                    onclick="event.preventDefault();
                            ...
                            <span class="bg-brand-black text-xl  py-2 px-4 transition-all rounded-3xl hover:rounded-2xl  duration-200 text-white ease-in-out ">Deconnecter</span>
            </x-nav-link>
        </form>
...
<!--                     <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="lg:hidden block">
        <div class=" ">
            <a href="#" class="font-medium block px-1.5 py-2 text-base text-black hover:bg-brand-black hover:text-white transition-colors duration-150 rounded">Passer un test</a>
            <a href="#" class="font-medium block px-1.5 py-2 text-base text-black hover:bg-brand-black hover:text-white transition-colors duration-150 rounded">A propos</a>
            <a href="#" class="font-medium block px-1.5 py-2 text-base text-black hover:bg-brand-black hover:text-white transition-colors duration-150 rounded">Contact</a>
                        @if (Route::has('login'))
            @auth
