...
<p class="text-sm md:w-1/2 font-medium text-[#6a6f7a] hover:text-white duration-150 transition-opacity">
...
<div class="flex flex-col justify-center h-full items-center gap-2 w-full ">
    ...
    <div class="flex flex-col justify-center items-center gap-2 ">
        ...
        <a class='group text-sm font-medium text-brand-gray transition-all duration-300 ease-in-out' href={{url('/')}}>
