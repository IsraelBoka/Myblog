    ...
    <nav class="mx-auto max-w-6xl px-4 lg:px-8 mt-4"  x-data="{ open: false }">
        <ul class=" flex  justify-between lg:justify-between text-xl gap-5 font-medium ">
            ...
            <div class="hidden lg:flex">
                ...
                @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}" class="bg-[#292929] text-xl  z-10 py-2 px-4 transition-all rounded-3xl hover:rounded-2xl  duration-200 text-white ">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="bg-[#292929] text-xl z-10  py-2 px-4 transition-all rounded-3xl hover:rounded-2xl  duration-200 text-white ">Se connecter </a>
