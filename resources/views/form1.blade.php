            ...
            <form class="">
              <div class="space-y-12 pb-8">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <textarea id="description" name="description" class="block lg:w-96 rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"></textarea>
