                ...
                <div class="  ">
                  ...
                  <div class=" grid grid-cols-1 gap-y-4">
                    <div class="sm:col-span-4">
                      ...
                      <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                          <input type="text" name="Titre" id="Titre" autocomplete="Titre"  placeholder="Ajoutez un titre ">
                        </div>  
                      </div>
                    </div>
                    ...
                    <div class="col-span-full ">
                      ...
                      <div class="mt-2">
                        <textarea placeholder="Ajoutez une description..." id="description" name="description" rows="3" ></textarea>
                      </div>
                    ...
                    <div class="col-span-full py-4">
                      ...
                      <input type="file" name="cover-photo" id="cover-photo" class="block w-full py-2 px-3 border bg-white rounded-md shadow-sm  border-gray-800 ring-inset ring-gray-800 placeholder:text-gray-400 focus:ring focus:ring-inset focus:ring-brand-black sm:py-1.5 sm:text-sm sm:leading-6  ">
                    </div>
                  </div>
                </div>
